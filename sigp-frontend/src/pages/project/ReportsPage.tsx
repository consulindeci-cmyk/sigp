...
export default function ReportsPage() {
  return (
    <div className="flex flex-col min-h-full bg-muted/10 p-6 lg:p-8">
      {/* 1. En-tête de page */}
      <div className="mb-8">
        <PageHeader title="
          Rapports & exports" description="
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 mb-8">
        ...
        {/* Ligne 1 */}
        <button className="bg-white rounded-lg shadow-sm hover:shadow-sm hover:-translate-y-0.5 transition-all p-6 flex flex-col text-left border-l-4 border-l-[#2563EB] group">
        ...
        <button className="bg-white rounded-lg shadow-sm hover:shadow-sm hover:-translate-y-0.5 transition-all p-6 flex flex-col text-left border-l-4 border-l-[#0F766E] group">
        ...
        <button className="bg-white rounded-lg shadow-sm hover:shadow-sm hover:-translate-y-0.5 transition-all p-6 flex flex-col text-left border-l-4 border-l-[#F97316] group">
        ...
        {/* Ligne 2 */}
        <button className="bg-white rounded-lg shadow-sm hover:shadow-sm hover:-translate-y-0.5 transition-all p-6 flex flex-col text-left border-l-4 border-l-[#16A34A] group">
        ...
        <button className="bg-white rounded-lg shadow-sm hover:shadow-sm hover:-translate-y-0.5 transition-all p-6 flex flex-col text-left border-l-4 border-l-[#0A1628] group">
        ...
        <button className="bg-white rounded-lg shadow-sm hover:shadow-sm hover:-translate-y-0.5 transition-all p-6 flex flex-col text-left border-l-4 border-l-[#DC2626] group">
      ...
      <div className="bg-[#EEF2FF] border border-blue-100/50 rounded-lg p-6 text-center shadow-sm">
