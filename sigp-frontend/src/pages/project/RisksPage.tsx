...
import { RiskSlideOver } from '@/components/project/risks/RiskSlideOver';
import type { RiskSlideOverSavePayload } from '@/components/project/risks/RiskSlideOver';
...
export default function RisksPage() {
  useParams<{ id: string }>(); // réservé pour l'intégration API future
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <PageHeader
        ...
        description="Identification, analyse et suivi du registre des risques du projet"
        badges={
          kpis.critique > 0
            ? <Badge variant="destructive">{kpis.critique} critique{kpis.critique > 1 ? 's' : ''}</Badge>
            : undefined
        }
        actions={
          ...
          <div className="bg-card border border-border rounded-lg p-5">
            ...
            <ResponsiveContainer width="100%" height={190}>
              <AreaChart data={MOCK_RISK_EVOLUTION} margin={{ left: -10, right: 10, top: 4, bottom: 0 }}>
                <defs>
                  <linearGradient id="prit" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="5%"  stopColor="hsl(var(--destructive))" stopOpacity={0.3} />
                    <stop offset="95%" stopColor="hsl(var(--destructive))" stopOpacity={0} />
                  </linearGradient>
                  <linearGradient id="pelev" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="5%"  stopColor="hsl(var(--warning))" stopOpacity={0.3} />
                    <stop offset="95%" stopColor="hsl(var(--warning))" stopOpacity={0} />
                  </linearGradient>
                  <linearGradient id="pmod" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="5%"  stopColor="hsl(var(--primary))" stopOpacity={0.2} />
                    <stop offset="95%" stopColor="hsl(var(--primary))" stopOpacity={0} />
                  </linearGradient>
                  <linearGradient id="pfai" x1="0" y1="0" x2="0" y2="1">
                ...
                <Area type="monotone" dataKey="critique" name="Critique" stackId="1"
                  stroke="hsl(var(--destructive))" fill="url(#prit)" strokeWidth={1.5} />
                <Area type="monotone" dataKey="eleve" name="Élevé" stackId="1"
                  stroke="hsl(var(--warning))" fill="url(#pelev)" strokeWidth={1.5} />
                <Area type="monotone" dataKey="modere" name="Modéré" stackId="1"
                  stroke="hsl(var(--primary))" fill="url(#pmod)" strokeWidth={1.5} />
                <Area type="monotone" dataKey="faible" name="Faible" stackId="1"
                  stroke="hsl(var(--success))" fill="url(#pfai)" strokeWidth={1.5} />
              </AreaChart>
            </ResponsiveContainer>
          </div>
        </div>
