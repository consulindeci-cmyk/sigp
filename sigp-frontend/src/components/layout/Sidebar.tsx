...
export function Sidebar() {
  ...
  return (
    <aside className={cn(
      'flex flex-col bg-[#0A0F1E] border-r border-[#1E293B] transition-all duration-300 shrink-0 h-full z-30',
      ...
      <div className="flex items-center gap-3 px-3 py-4 border-b border-[#1E293B] shrink-0">
        ...
        <button onClick={toggleSidebar}
          className="ml-auto text-[#94A3B8] hover:text-white transition-colors p-1 rounded-lg hover:bg-white/5">
