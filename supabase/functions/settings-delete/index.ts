...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    const body: DeleteSettingBody = await req.json();
    ...
    try {
      ...
      console.error('[settings-delete] historique', historiqueError);
    }

    return json({ message: 'Paramètre supprimé' });
  } catch (err) {
